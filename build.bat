...
echo Compiling...
cl.exe /nologo /std:c++17 /EHsc /W4 /O2 /DUNICODE /D_UNICODE src/main.cpp src/MainWindow.cpp src/MainWindow_Actions.cpp src/MainWindow_Dialogs.cpp src/MainWindow_Session.cpp src/ProcessUtils.cpp src/ConnectionManager.cpp src/CredentialManager.cpp src/SnippetManager.cpp src/Subclass.cpp src/InputHook.cpp build/LibreTerm.res /Fe:build/LibreTerm.exe /link user32.lib gdi32.lib comctl32.lib shell32.lib comdlg32.lib advapi32.lib

...
echo Compiling...
cl.exe /nologo /std:c++17 /EHsc /W4 /O2 /DUNICODE /D_UNICODE src/main.cpp src/MainWindow.cpp src/ProcessUtils.cpp src/ConnectionManager.cpp src/Subclass.cpp build/LibreTerm.res /Fe:build/LibreTerm.exe /link user32.lib gdi32.lib comctl32.lib shell32.lib comdlg32.lib
